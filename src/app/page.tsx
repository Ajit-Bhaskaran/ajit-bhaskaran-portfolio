  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
          ...
          <div className="max-w-3xl">
            ...
            <div className="text-lg text-gray-700 leading-relaxed space-y-4">
              ...
              <p>
                ...
                <strong> National Australia Bank</strong>, <strong>Infosys</strong>, and <strong>Oracle</strong> 💭
              </p>
            </div>

            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <a href="/#about" className="inline-flex items-center text-gray-900 hover:text-gray-600 transition-colors">
                More about me
      ...
      <section id="work" className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-light text-gray-900 mb-12">Work</h2>
          ...
          <div className="space-y-16">
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">AWS</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Python</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Terraform</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Cloudability</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Jenkins</span>
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Terraform</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Ansible</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Python</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Jenkins</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">GitLab</span>
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">SAS Viya</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">PostgreSQL</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Oracle</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Linux</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Monitoring</span>
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Technical Writing</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">DevOps</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Cloud Engineering</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">Best Practices</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-light text-gray-900 mb-8">Recent writing</h2>
          ...
          <div className="mt-8">
            <Link href="/blog" className="inline-flex items-center text-gray-900 hover:text-gray-600 transition-colors">
              Read all posts →
            </Link>
          </div>
        </div>
      ...
      <section id="contact" className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-light text-gray-900 mb-8">Have something in mind?</h2>
          <p className="text-lg text-gray-700 mb-8">
            Reach out at <a href="mailto:ajit.kanoli@gmail.com" className="text-gray-900 hover:text-gray-600 transition-colors">ajit.kanoli@gmail.com</a>
          </p>
          
          <div className="flex justify-center space-x-6">
            <a href="mailto:ajit.kanoli@gmail.com" className="text-gray-600 hover:text-gray-900 transition-colors">
              <Mail className="w-5 h-5" />
            </a>
            <a href="https://www.linkedin.com/in/ajitbhaskaran/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="https://github.com/Ajit-Bhaskaran" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">
